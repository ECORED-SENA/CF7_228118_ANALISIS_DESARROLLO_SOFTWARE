...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.bg-c9
      .col-12
        .px-5
          ...
          p.mb-5(data-aos="fade-right") Al imaginar que el problema es #[b mucho más complejo] que el descrito en el ejemplo anterior, se concluye que existen #[b tantas soluciones como el enfoque o lógica empleada por cada aprendiz o persona]. Sin embargo, lo que sí es común en todos los casos es que se realizaron #[b unas fases mentales secuencialmente ordenadas], las cuales son:
    ...
    .row.justify-content-center.mb-5
      ...
      .col-11.col-md-10.col-lg-4.mb-4.mb-lg-0(data-aos="fade-up")
        .p-4.bg-c11
          figure.mb-4
      ...
      .col-11.col-md-10.col-lg-4(data-aos="fade-left")
        .p-4.bg-c11
          figure.mb-4
    ...
    p.mb-5(data-aos="fade-right") La figura presenta las fases y sus relaciones en el proceso de diseño de algoritmos de programas informáticos, que están basados en un algoritmo que posteriormente es escrito en un lenguaje de programación.
    .row
      .col-12
        .p-4.bg-c3(data-aos="fade-down")
          .titulo-sexto.color-acento-contenido.mb-4
    ...
    p(data-aos="fade-right") Como los programas de computador tienen por objetivo resolver problemas muy puntuales, lo primero que se debe realizar para resolverlos es lograr una mejor comprensión posible de estos.
    p.mb-5(data-aos="fade-right") Para realizar esta actividad se debe:
    .row.mb-4.pt-4(data-aos="fade-down")
      .col-auto.bg-c4
        .px-3.pb-0
          .row.align-items-end
    ...
    p.mb-5(data-aos="fade-right") #[b Ejemplo:]
    .row.justify-content-center.mb-5
    ...
    p.mb-5(data-aos="fade-right") Otro punto importante en la fase de análisis del problema es determinar cuál es la información disponible, por lo tanto:
    .row.justify-content-center.mb-4
      ...
      .col-md-10.col-lg-4.mb-4.mb-lg-0(data-aos="fade-up")
        .p-4.bg-c8.h-100
          .row.align-items-center
            .col-auto
              figure
      ...
      .col-md-10.col-lg-4(data-aos="fade-left")
        .p-4.bg-c8.h-100
          .row.align-items-center
            .col-auto
              figure
    ...
    p.mb-5(data-aos="fade-right") Otro elemento a resaltar es el nivel de conocimiento y las limitaciones que se tienen en el ámbito o el contexto del problema que está tratando de resolver. Por ejemplo, si el problema requiere conceptos financieros para entender la naturaleza de los datos, o si es necesario adquirir nueva información y/o poder consultarla, para estar seguros de que es posible tratarla conforme el contexto lo requiera.
    .row.mb-4.pt-4(data-aos="fade-down")
      .col-auto.bg-c4
        .px-3.pb-0
          .row.align-items-end
